import{a as p}from"./vendor-f310ef70.js";(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))r(e);new MutationObserver(e=>{for(const s of e)if(s.type==="childList")for(const l of s.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&r(l)}).observe(document,{childList:!0,subtree:!0});function i(e){const s={};return e.integrity&&(s.integrity=e.integrity),e.referrerPolicy&&(s.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?s.credentials="include":e.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(e){if(e.ep)return;e.ep=!0;const s=i(e);fetch(e.href,s)}})();function h({filter:t,page:o=1,limit:i=12,type:r}){return p.get(`https://energyflow.b.goit.study/api/${r}`,{params:{filter:t,page:o,limit:i}})}const d="dateNow",g="quoteDay",f=document.getElementById("description"),m=document.getElementById("author-quote");function y(){const t=new Date,o=`${t.getDate()}.${t.getMonth()+1}.${t.getFullYear()}`,i=localStorage.getItem(d);if(i===o){const r=JSON.parse(localStorage.getItem(g));if(r){const{author:e,quote:s}=r;f.textContent=s,m.textContent=e}else u();return}(!i||i!==o)&&(localStorage.setItem(d,o),u())}function u(){h({type:"quote"}).then(({data:t})=>{const{author:o,quote:i}=t,r={author:o,quote:i};localStorage.setItem(g,JSON.stringify(r)),f.textContent=i,m.textContent=o}).catch(t=>{console.error("Error fetching quote:",t)})}y();const a=document.querySelector(".add-to-favorites-btn"),c=document.querySelectorAll(".remove-from-favorites-btn"),b=document.querySelector(".list-favorites"),n=JSON.parse(localStorage.getItem("favoriteExercise"));n?a.style.display="none":c.style.display="none";a.addEventListener("click",()=>{localStorage.setItem("favoriteExercise",JSON.stringify(n));const t=`
