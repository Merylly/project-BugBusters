...
--><span class="block-info-static-value">/3 min</span>
    ...
    `;g.innerHTML=D}function G(e,t){Array.from(e).forEach((a,o)=>{o<t&&a.classList.remove("dimmed-star")})}const c="favorites",m=document.querySelector(".list-favorites");document.querySelector(".add-to-favorites-btn");document.querySelector(".delete-from-fav");document.querySelector(".start-btn");const E=document.querySelector(".backdrop"),q=document.querySelector(".message-block-favorites");if(m){const e=JSON.parse(localStorage.getItem(c))||[];M(e),m.addEventListener("click",V)}E&&E.addEventListener("click",Z);function V(e){const t=e.target.closest(".delete-from-fav");if(t){const s=t.dataset.id,o=(JSON.parse(localStorage.getItem(c))||[]).filter(({_id:i})=>i!==s);console.log(o),localStorage.setItem(c,JSON.stringify(o)),M(o)}}function Z(e){if(!e.target.classList.contains("add-to-favorites-btn"))return;const s=JSON.parse(localStorage.getItem(c))||[],a=JSON.parse(localStorage.getItem("exercise"));if(e.target.textContent.trim()==="Add to favorites")s.push(a),localStorage.setItem(c,JSON.stringify(s)),e.target.innerHTML=`Remove from <svg class="heart-icon" viewBox="0 0 32 32" width="13" height="13">
            ...
            <use href="../img/sprite.svg#icon-like" />
          </svg>`}function M(e){if(console.log(e),e.length===0){q.classList.remove("hidden"),m.innerHTML="";return}q.classList.add("hidden");const t=e.map(s=>`
        <li class="item-favorites" >
             ...
             <ul class="list-ex-category">
               <li>
                 <p class="category-text-accent">Burned calories:<span class="category-text"> ${s.burnedCalories}/ 3 min</span
                   >
                 </p>
               </li>
               <li>
                 <p class="category-text-accent">Body part:<span class="category-text"> ${s.bodyPart}</span>
                 </p>
               </li>
               <li>
                 <p class="category-text-accent">
                   Target:<span class="category-text"> ${s.target}</span>
                 </p>
               </li>
             </ul>
           </li>
